...
class _SettingPageState extends State<SettingPage> {
  ...
  Future<void> changeLang(String value) async {
    ...
    _isArabic = false; // Default to English
    if (value == 'Arabic') {
    ...
    // Ensure the locale is fully updated before rebuilding the UI
  ...
  Widget build(BuildContext context) {
    if (context.locale.languageCode == 'ar') _isArabic = true;
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  ElevatedButton(
                    onPressed: () => changeLang('English'),
                    child: const Text('EN'),
                  ),
                  const SizedBox(width: 10),
                  ElevatedButton(onPressed: () => changeLang('Arabic'), child: const Text('AR')),
                ],
              ),
