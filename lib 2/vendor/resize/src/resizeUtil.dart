...
class ResizeUtil {
  ...
  void init(
    ...
    if (kIsWeb) {
      ...
      if ((_orientation == Orientation.portrait && _screenWidth < 600) || (_orientation == Orientation.landscape && _screenHeight < 600)) {
  ...
  double scalarPixel(num input) => allowtextScaling ? input * scale * textScaleFactor : input * scale;
