...
class Sync {
  ...
  Map<String, Object?> toMap() {
    var map = <String, dynamic>{
      ...
      'lastPushEstimate': lastPushEstimate?.millisecondsSinceEpoch,
      'lastPushInvoice': lastPushInvoice?.millisecondsSinceEpoch,
      'lastPushCashier': lastPushCashier?.millisecondsSinceEpoch,
      'lastPushPayments': lastPushPayments?.millisecondsSinceEpoch,
      'lastPushCreditNote': lastPushCreditNote?.millisecondsSinceEpoch,
      'lastPushCreditNoteRefund': lastPushCreditNoteRefund?.millisecondsSinceEpoch,
      'lastWorkOrder': lastWorkOrder?.millisecondsSinceEpoch,
      'lastPushPayout': lastPushPayout?.millisecondsSinceEpoch,
    };
    return map;
  }
